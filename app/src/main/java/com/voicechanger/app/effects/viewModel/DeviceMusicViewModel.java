...
import static com.voicechanger.app.effects.activity.OpenFileActivity.imgSort;
...
public final class DeviceMusicViewModel extends BaseViewModel {
    ...
    public void getAudioDataClass(Context context, LinearLayout linearLayout, RelativeLayout ads, LottieAnimationView noData) {
    ...
    private class GetAudioData extends AsyncTask<String, String, String[]> {
        ...
        public GetAudioData(Context ctx, LinearLayout lly, RelativeLayout ads, LottieAnimationView noData) {
            this.ctx = ctx;
            this.lly = lly;
            adsLayout = ads;
            this.noData = noData;
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try {
                ...
                Log.e("rrr----", "doInBackground: audioModelList ::  " + audioModelList.size());
            } catch (Exception e) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (size >= 20) {
                    if (duration == null) {
                        ...
                        duration = getBaseDuration(context, uriPath);
                    }
