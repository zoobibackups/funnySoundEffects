...
public final class SaveFileService extends Service {
    ...
    private final void notificationSend() {
        Notification notification = new NotificationCompat.Builder((Context) this, AppConstant.channelId).setSmallIcon((int) R.drawable.set_as_ring).setContentTitle(getString(R.string.saving_audio)).setAutoCancel(true).build();
