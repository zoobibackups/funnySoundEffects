package com.voicechanger.app.effects.recordingServices;
...
public class ServiceRecordingVoice extends Service {
    private static final String extraAcvtivityStarter = "com.soundeffect.voiceavatar.changer.EXTRA_ACTIVITY_STARTER";
    ...
    public void recordingStop() {
        try {
            ...
            Log.e("rec---", "recordingStop: strFileName :  " + strFileName);
            Log.e("rec---", "recordingStop: strFilePath :  " + strFilePath);
            Log.e("rec---", "recordingStop: mElapsedMillis :  " + mElapsedMillis);
    ...
    private Notification notificationCreate() {
        return new NotificationCompat.Builder(getApplicationContext(), Build.VERSION.SDK_INT >= 26 ? notiChannelCreate() : "").setSmallIcon((int) R.drawable.ic_mic_white_36dp).setContentTitle(getString(R.string.notification_recording)).setOngoing(true).build();
    }
