...
import static com.voicechanger.app.effects.activity.CreationActivity.imgSort;
...
public final class CreationViewModel extends BaseViewModel {
    ...
    public void getAudioDataClass(Context context, LinearLayout linearLayout, RelativeLayout adsLayout, LottieAnimationView noData) {
    ...
    private class GetAudioData extends AsyncTask {
        ...
        public GetAudioData(Context ctx, LinearLayout lly, RelativeLayout adsLayout, LottieAnimationView noData) {
            this.ctx = ctx;
            this.ads = adsLayout;
            this.layout = lly;
            this.noData = noData;
